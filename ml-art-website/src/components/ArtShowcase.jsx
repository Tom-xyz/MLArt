...
function ArtShowcase(props) {
  ...
  const artCardConfig = [
    ...
    {
      src: "https://images.unsplash.com/photo-1556139954-ec19cce61d61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=720&q=80",
      title: '"Red Ocean"',
      createdBy: "Tom",
  ...
  function createArtCard(props) {
    return (
      <Card key={props.title} sx={{ flex: 1 }}>
        <Card.Section>
          <AspectRatio ratio={4 / 3} sx={{ maxWidth: 400 }} mx="auto">
            <Image
              src={props.src}
              sx={{ flex: 1 }}
              alt={props.title}
  ...
  return (
    <Container size="xl" sx={{ display: "flex", flex: 1 }} p="sm">
      {artCards}
    </Container>
  );
}
